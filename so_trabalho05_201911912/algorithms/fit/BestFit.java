...
public class BestFit extends FitAlgSuperClass implements MemoryAlgInterface {

  public BestFit(AnchorPane memory, VBox processWaitArea, MainControllerInterface controller) {
